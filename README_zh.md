...
> **重要提示：** 此版本为 ParManus 项目的初始完整版，包含了其核心理念。最新更新请访问 https://github.com/FoundationAgents/ParManus。
...
Manus 非常棒，但 ParManus 无需邀请码即可实现任何创意 🛫！
...
用 ParManus 开启你的智能体之旅吧！

我们也非常高兴地向大家介绍 [ParManus-RL](https://github.com/ParManus/ParManus-RL)，这是一个专注于基于强化学习（RL，例如 GRPO）的方法来优化大语言模型（LLM）智能体的开源项目，由来自UIUC 和 ParManus 的研究人员合作开发。
...
ParManus 需要配置使用的 LLM API，请按以下步骤设置：
...
ParManus 由 MetaGPT 社区的贡献者共同构建，感谢这个充满活力的智能体开发者社区！
